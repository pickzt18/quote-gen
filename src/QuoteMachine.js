  ...
  handleClick = () => {
    ...
    fetch(this.END_POINT)
      ...
      .then(data => {
        ...
        document.getElementById('boxy').style.backgroundColor =
          'rgba(' +
          this.state.color.r +
          ', ' +
          this.state.color.g +
          ...
          <div id="boxy" className="col-sm-8 centering rounded-circle">
            <div className="center-text">
              <div className="text-quote">
                ...
                <br />
                <p id="text" className="text-body">
                  {this.state.quote}
                </p>
              </div>
              <p id="author" className="text-body">
                --{this.state.author}--
              </p>
              <a id="tweet-quote" href="twitter.com/intent/tweet">
                <button className="btn btn-outline-dark btn-sm">Tweet</button>
              </a>
            </div>
          </div>
        </div>
